...
export function AuthMarketing({ heading, tagline }: Props) {
  return (
  ...
  return (
    <div className="relative rounded-2xl bg-white p-5 shadow-[0_30px_60px_-15px_rgba(15,23,42,0.45)] ring-1 ring-black/5">
      ...
      <div className="mt-4 grid grid-cols-3 gap-2">
        <Metric label="Employees" value="48" />
...
function DonutCard() {
  const segments = [
    { color: "bg-blue-600", label: "Engineering" },
    { color: "bg-blue-400", label: "Sales" },
    { color: "bg-blue-300", label: "Design" },
  ];
  return (
...
function ActivityCard() {
  const rows = [
    { name: "Sarah Chen", role: "Leave request", color: "bg-emerald-500" },
    { name: "James Wilson", role: "OT request", color: "bg-amber-500" },
  ];
  return (
