...
export async function previewLeave(
  ...
  // Detect overlap with existing PENDING / APPROVED leaves so the form can
  // warn the user before submission. Auto-generated overflow children are
  // excluded — they're internal bookkeeping and would double-count.
