...
export const env = createEnv({
  server: {
    ...
    NEON_PARENT_BRANCH_ID: z.string().min(1).optional(),
    NEON_BRANCH_ROLE_NAME: z.string().default("neondb_owner"),
  ...
  runtimeEnv: {
    ...
    NEON_BRANCH_ROLE_NAME: process.env.NEON_BRANCH_ROLE_NAME,
