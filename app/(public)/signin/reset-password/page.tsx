...
import { ResetPasswordForm } from "@/app/[slug]/signin/reset-password/reset-form";
...
export default async function GlobalResetPasswordPage({ searchParams }: Props) {
  const [{ token, email }, { t }] = await Promise.all([searchParams, getDict()]);
